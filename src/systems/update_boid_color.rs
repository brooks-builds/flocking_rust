...
pub fn update_boid_color_system(world: &mut World, ticks: usize) {
    let color_change_every: &usize = world
        .get_resource::<ResourceNames>(crate::resource_names::ResourceNames::ColorChangeSpeed)
        .unwrap();
    let color_change_rate: &f32 = world
        .get_resource::<ResourceNames>(crate::resource_names::ResourceNames::ColorChangeRate)
        .unwrap();
